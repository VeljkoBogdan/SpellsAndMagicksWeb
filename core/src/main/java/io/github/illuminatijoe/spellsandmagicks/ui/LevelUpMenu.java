...
public class LevelUpMenu implements Screen {
    ...
    public void render(float d) {
        ...
        batch.begin();
            ...
            for (Spell spell : spells) {
                ...
                optionButton.setPosition(Gdx.graphics.getWidth() / 2f - 300, Gdx.graphics.getHeight() / 2f - 120 * pos);
    ...
    private void addSpellSystems(Spell spell) {
        ...
        if (spell instanceof ElectricityAuraSpell) {
            ElectricityAuraSpell electricityAuraSpell = (ElectricityAuraSpell) spell;
        ...
        } else if (spell instanceof ExplosionMagick) {
            ExplosionMagick explosionMagick = (ExplosionMagick) spell;
        ...
        } else if (spell instanceof PoisonMagick) {
            PoisonMagick poisonMagick = (PoisonMagick) spell;
