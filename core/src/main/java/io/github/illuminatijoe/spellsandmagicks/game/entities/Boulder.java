...
public class Boulder extends Entity {
    public Boulder(Player player, Vector2 pos) {
        this.add(new AnimationComponent(AssetLoader.boulderAnimation));
